            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-center">
              {filteredBooks.map(book => {
                ...
                return (
                  <Card
                    key={id}
                    className="w-64 flex flex-col overflow-hidden shadow-xl bg-slate-800 border-slate-700 group hover:shadow-2xl hover:shadow-purple-500/25 hover:-translate-y-2 transition-all duration-300 rounded-2xl"
                  >
                    {/* Icon Cover */}
                    ...
                    <CardFooter className="flex justify-between items-center p-4 mt-auto border-t border-slate-700/50">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {hasPdf && (
                          <Dialog>
                            <DialogTrigger asChild>
                              <button className="p-2.5 rounded-full shadow-lg transition-all duration-200 bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 hover:shadow-xl hover:shadow-blue-500/25 transform hover:scale-110">
                        ...
                        {hasAudio && !hasPdf && (
                          <button
                            className="p-2.5 rounded-full shadow-lg transition-all duration-200 bg-gradient-to-r from-purple-500 to-purple-600 text-white hover:from-purple-600 hover:to-purple-700 hover:shadow-xl hover:shadow-purple-500/25 transform hover:scale-110"
                            onClick={() => {
